...
do
	...
	ssh -f nebula111 "iperf3 -c dc98::9898:9800:4 -p 10001 -O 10 -t 15"
	ssh -f nebula112 "iperf3 -c dc98::9898:9800:4 -p 10002 -O 10 -t 15"
...
for p in $(ps -aef | grep "iperf3 -s" | grep -v grep | gawk '{print $2}')
do
	kill -9 $p
done
